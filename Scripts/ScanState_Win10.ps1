...
.\scanstate.exe "$MigStorePath" /o /vsc /i:MigDocs.xml /i:MigApp.xml /i:MigAppData.xml /v:13 /localonly /listfiles:"$ListFilePath" /l:"$LogFilePath" /progress:"$ProgFilePath" /c /uel:100
